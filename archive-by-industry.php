		...
		<div class="column three-fourths spacer">
			<div class="column full">
				<div class="breadcrumbs">
					<p><a href="<?php echo get_site_url(); ?>">Home</a> / <a href="<?php echo get_site_url(); ?>/solutions">Solutions</a> / By Industry</p>
				</div>
			</div>
			<div class="column full">
			...
			<div class="column third">
				...
				<div class="column full">
					<?php query_posts(array( 'post_type' => 'by-industry', 'post_parent' => 0 , 'orderby' => 'menu_order' , 'order'   => 'ASC' ) ); ?>
